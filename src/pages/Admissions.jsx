...
const Admissions = () => {
  ...
  const admreqs = [
    {
      req: "Completed Application Form",
      desc: "Fill out all required fields in the online application",
    },
    {
      req: "Birth Certificate",
      desc: "Official copy of student birth certificate",
    },
    {
      req: "Academic Records",
      desc: "Previous school transcripts and report cards",
    },
    {
      req: "Immunization Records",
      desc: "Up-to-date vaccination documentation",
    },
    {
      req: "Passport Photos",
      desc: "Two recent passport-sized photographs",
    },
    {
      req: "Parent/Guardian ID",
      desc: "Valid identification documents",
    },
  ];
  ...
  const impdts = [
    ...
    },
    {
      ...
      name: "Admission Decisions Released",
      day: "April 15",
    },
    {
      icon: <CheckCircle size={25} />,
      name: "Enrollment Confirmation Due",
      day: "May 31",
    },
  ];
  ...
  const fees = [
    ...
    {
      sch: "Junior High School",
      grade: "JHS 1-3",
      price: "GH₵ 9,500",
      bg: "#16a34a",
    },
    {
      sch: "Senior High School",
      grade: "SHS 1-3",
      price: "GH₵ 12,000",
      bg: "#ca8a04",
    },
    ...
    <>
      <div className="bg-red-800 py-5 px-10 pt-25 lg:py-25 flex items-center gap-2  justify-between">
        <div className="text-white mt-5">
          ...
          <p>
            Join our community of learners and embark on an exciting educational
            journey
          </p>
        </div>
      ...
      <section className="section-padding">
        <div className="section-heading">
          <span className="text-yellow-600 text-sm font-medium uppercase tracking-widest">
            Simple Process
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {steps.map((step) => (
            <div
              key={step}
              className=" relative border border-gray-300 bg-white rounded-2xl px-5 py-7 flex flex-col gap-3"
            >
              <div
                className="absolute w-7 h-7 rounded-full text-center text-white font-medium -top-4"
                style={{ backgroundColor: step.bg1 }}
              >
                {step.step}
              </div>
              <div
                className="w-12 h-12 rounded-xl flex items-center justify-center"
                style={{ backgroundColor: step.bg2 }}
              >
                {step.icon}
              </div>
            ...
            <div>
              ...
              <div className="border border-yellow-500 bg-amber-50 rounded-2xl px-5 py-7 mt-10">
                ...
                <p className="lg:text-sm text-gray-500">
                  We accept applications throughout the year based on
                  availability. Apply early to secure your spot!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-2xl flex gap-4 px-4 py-8 mt-10">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              Merit-based scholarships and need-based financial aid are
