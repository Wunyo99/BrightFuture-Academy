import { BookOpen, Calendar, Film, Megaphone, MoveRight, Trophy, Users2 } from "lucide-react"
        ...
        <>
            <div className="bg-red-800 py-5 px-10 pt-25 lg:py-25 flex items-center gap-2  justify-between">
                <div className="text-white mt-5">
                    ...
                    <p>Stay updated with the latest happenings at Bright Future Academy</p>
                </div>
            ...
            <section className="section-padding">
                <div className="section-heading">
                    <p className="uppercase text-sm font-medium text-yellow-600 tracking-widest mb-2">Latest Updates</p>
                    <h1 className="section-title">Recent News</h1>
                    <p className="section-description">Celebrating achievements and sharing important announcements</p>
                </div>
                        ...
                        <div key={index} className="bg-white shadow-xl rounded-xl overflow-hidden">
                            <div className={`${item.bg} p-6 `}>
                                <div className="flex justify-between items-center mb-4 text-white">
                                    <span className="text-sm font-medium bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full">{item.type}</span>
                                    <p>{item.icon}</p>
                                </div>
            ...
            <section className="section-padding">
                <div className="section-heading">
                    <p className="uppercase text-sm font-medium text-yellow-600 tracking-widest mb-2">Mark Your Calendar</p>
                    <h1 className="section-title">Upcoming Events</h1>
                    <p className="section-description">Join us for exciting activities and important school events</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
