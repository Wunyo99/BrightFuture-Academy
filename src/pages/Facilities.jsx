    ...
    const facilities = [
        {
            ...
            features: ['Spacious seating', 'Whiteboards', 'Proper lighting', 'Good ventilation']
        },
        {
            ...
            features: ['Digital catalog', 'Study rooms', 'Reading corners', 'Librarian support'],
        },
        {
        ...
        },
        {
            ...
            features: ['Latest hardware', 'Software suite', 'Coding platforms', 'Tech support']
        },
        {
        ...
        },
        {
            ...
            features: ['Art supplies', 'Drawing boards', 'Exhibition corner', 'Art instructor']
        },
        {
            ...
            features: ['Keyboards and drums', 'Recording setup', 'Acoustic panels', 'Music instructors']
        },
        {
            ...
            features: ['Football field', 'Athletics area', 'Sports equipment', 'Coaching support']
        },
        {
            ...
            features: ['Experienced drivers', 'Safe buses', 'Regular maintenance', 'Morning and closing routes']
        },
        {
        ...
        },
        {
            ...
            features: ['Trained nurse', 'First aid equipment', 'Emergency care', 'Clean environment']
        }
        ...
        <>
            <div className="bg-red-800 py-5 px-10 pt-25 lg:py-25 flex items-center gap-2  justify-between">
                <div className="text-white mt-5">
                    <h1 className="text-4xl md:text-5xl font-bold mb-2">Our Facilities</h1>
                    <p>World-class infrastructure designed to enhance learning and development</p>
                </div>
            ...
            <section className="section-padding bg-red-100">
                <div className="section-heading">
                    <p className="uppercase tracking-wider font-medium text-yellow-600 text-sm mb-2">Excellence In Infrastructure</p>
                    <h1 className="section-title">Campus Features</h1>
                    <p className="section-description">We provide state-of-the-art facilities that support comprehensive education</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                    {facilities.map((facility, index) => (
                        <div key={index} className="bg-white rounded-xl shadow-xl overflow-hidden">
                            <img src={facility.img} alt={facility.title} className="h-60 w-full hover:scale-102 duration-300" />
                            <div className="space-y-4 px-4 py-5">
                                <h1 className={`font-bold text-2xl ${facility.color}`}>{facility.title}</h1>
                                <p>{facility.desc}</p>
                                <div className="grid grid-cols-2 gap-3">
                                    {facility.features.map((feature, ftindex) => (
                                        <div key={ftindex} className="flex items-center gap-2 text-sm">
