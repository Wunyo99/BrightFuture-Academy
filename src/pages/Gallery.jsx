        ...
        <>
            <div className="bg-red-800 py-5 px-10 pt-25 lg:py-25 flex items-center gap-2  justify-between">
                <div className="text-white mt-5">
                    ...
                    <p>Explore moments that capture the vibrant life at Bright Future Academy</p>
                </div>
            ...
            <section className="section-padding">
                <div className="section-heading">
                    <p className="uppercase text-sm text-yellow-600 font-medium mb-2 tracking-widest">Visual Stories</p>
                    <h1 className="section-title">Campus Life in Pictures</h1>
                    <p className="section-description">A glimpse into our daily activities, events, and achievements</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                    {pics.map((pic, idx) => (
                        <div key={idx} className="shadow-xl overflow-hidden rounded-xl">
                            <img src={pic.img} className="w-full h-60 object-cover hover:scale-105 transition-all duration-500" />
                            <div className="p-5">
            ...
            <section className="section-padding">
                ...
                <div className="flex flex-col md:flex-row gap-10">
                    <div className="rounded-xl shadow-xl overflow-hidden ">
                        <img src="https://t4.ftcdn.net/jpg/03/87/23/97/240_F_387239712_hpuZw0kJ00ppuTIHXQqrzqmbxemG1QaZ.jpg" className="w-full h-80 hover:scale-105 transition duration-500" />
                        <div className="bg-red-100 px-4 py-6">
                            <h3 className="text-3xl font-bold mb-3 text-red-800">Annual Sports Day 2025</h3>
                            <p className="text-gray-700 ">Students showcased their athletic talents in various competitions including track and field, basketball, and swimming.</p>
                        </div>
                    </div>
                    <div className="rounded-xl shadow-xl overflow-hidden ">
                        <img src="https://t4.ftcdn.net/jpg/09/79/82/79/240_F_979827910_RI9Lc4LQ01I0YAhLKwtAaR9okPlHjX3a.jpg" className="w-full h-80 hover:scale-105 transition duration-500" />
                        <div className="bg-red-100 px-4 py-6">
                            <h3 className="text-3xl font-bold mb-3 text-red-800">Science Exhibition 2025</h3>
                            <p className="text-gray-700 ">Our students presented innovative projects demonstrating their understanding of scientific principles and creativity.</p>
                        </div>
                    </div>
                </div>
            </section>
